...
9. "total_points": total points earned by the player across all game parts, numeric.
10. "pretend_instructions": the number of times the participant had to read the instructions for the pretend trials, before passing the comprehension check, numeric.
11. "nonpretend_instructions": the number of times the participant had to read the instructions for the non-pretend trials, before passing the comprehension check, numeric.
12. "pretend_hg_word": word used in pretend half game, string
13. "nonpretend_hg_word": word used in non-pretend half game, string
...
18. "word": the target word, string.
...
20. "final_keyboard_state": all letters guessed by the end of the game, an array of strings.
21. "num_clicks": the number of guesses needed to complete the game, numeric.
22. "points": number of poitns awarded for a game (15-num_misses), numeric.
23. "cheat": 1 in pretend games and pretend half-games, 0 in non-pretend games and non-pretend half-games, numeric (0/1).
24. "category": the category of the target word, string
25. "pretend": was the replay a replay of a pretend game? numeric (0/1)
26. "correct_response": P if pretend==1, N if pretend==0, string
27. "player": the subject_identifier of the player in the judge trial, numeric.
28. "key_press": decision in the judge trial: 80 for P, pretend, 79 for N, non-pretend
